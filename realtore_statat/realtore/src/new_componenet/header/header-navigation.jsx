...
import IphoneHiddinBox from './header_right_side/iphone_hiddin_box'
    ...
    class HeaderNave extends React.Component{
        render(){
            ...
            const navList = [["Buy","www.google.com",1],["sell","www.google.com",2],["Rent","www.google.com",3]
            ,["Mortgage","www.google.com",4],["Findrealtore","www.google.com",5],["My Home","www.google.com",7],
            ["New & Insights","www.google.com",6]
        ];
